...
```{r, echo=FALSE, fig.cap=paste0("<span style='font-size: 0.6em;'>Figure 1: A histogram of ", params$hemoglobin_value, " values (in ", params$unit, ") from a sample of individuals (Gender: ", params$gender, ", Age: ", params$age_min, "-", params$age_max, "). The solid curve represents the fitted data distribution after a ", params$model_name, " transformation. The vertical dashed lines mark the estimated 95% reference interval, with a lower limit at the 2.5th percentile (", params$lower_limit, " ", params$unit, ") and an upper limit at the 97.5th percentile (", params$upper_limit, " ", params$unit, ").</span>"), out.width="65%"}
