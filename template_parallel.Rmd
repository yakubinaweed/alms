...
```{r, echo=FALSE, fig.cap="<span style='font-size: 0.7em;'>Figure 2:.", out.width="70%"}
...
```{r, echo=FALSE, fig.cap="<span style='font-size: 0.7em;'>Figure 3:.", out.width="70%"}
...
```{r, echo=FALSE, fig.cap="<span style='font-size: 0.7em;'>Figure 4:.", out.width="70%"}
...
if (length(params$individual_plots) > 0) {
  for (i in seq_along(params$individual_plots)) {
    ...
    # This creates the plot for each subpopulation
    cat(paste0("```{r, echo=FALSE, fig.cap='<span style=\"font-size: 0.7em;\">Figure ", i + 4, ": Estimated reference interval for subpopulation ", i, ".</span>', out.width='70%'}\n"))
    cat(paste0("knitr::include_graphics('", params$individual_plots[[i]], "')\n"))
    cat("```\n\n")

    # This adds the summary text for each subpopulation
    cat("##### **Subpopulation Summary**\n")
    cat("```{r, echo=FALSE}\n")
    cat("cat('", params$individual_summaries[[i]], "')\n")
    cat("```\n")
