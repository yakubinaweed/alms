...
```{r, echo=FALSE, fig.cap="<span style='font-size: 0.7em;'>Figure 4:.", out.width="60%"}
...
if (length(params$individual_plots) > 0 && length(params$individual_plots) == length(params$individual_summaries)) {
